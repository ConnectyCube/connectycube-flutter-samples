# Video Chat code samples for Flutter, based on ConnectyCube platform
...
- [Video Chat code sample](https://github.com/ConnectyCube/connectycube-flutter-samples/tree/master/p2p_call_sample)
